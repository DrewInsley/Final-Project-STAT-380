...
Happiness %>% 
  ...
  geom_abline(aes(intercept = b0, slope = b1), data = models, alpha = 0.25, color = "dark red") + 
...
**We then found the optimal parameters for intercept and slope for a model predicting happiness score for each country based on GDP per capita.**
